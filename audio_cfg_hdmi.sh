...
echo "0x2129 0x1c" > /sys/class/i2c-dev/i2c-1/device/1-0064/regdump

# REG2
# BIT[7:6]: HDMI audio fomrat.  0: Force stereo, 1: Force TDM, 2: auto select
# BIT 0: Enable transmit audio channel X
...
# 0x00: HDMI
# 0xb0: I2S
echo "0x0120 0x00" > /sys/class/i2c-dev/i2c-1/device/1-0064/regdump
